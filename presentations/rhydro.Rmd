...
**Daniel Klotz** BOKU Vienna (<daniel.klotz@boku.ac.at>)
...
![shiny3](data/shinywright.png)
R based hydrology tools from the [Intelligent Water Decisions Research Group](http://waterdecisions.org/) of the University of Adelaide:
...
<img src="data/osmscale_fig.png" alt="" style="width: 400px;"/>
...
```
Looks similar in style to
[rdwd interactive map](data/mapDWD.html)
...
We are using the GR4J model, from the airGR package. 
This was developed by IRSTEA, France. 
See Perrin et al. (2003)

<img src="data/IMG_2001.PNG" alt="" style="width: 600px;"/>
...
Further resources can be found on the github page:
<https://github.com/brry/rhydro#resources>
